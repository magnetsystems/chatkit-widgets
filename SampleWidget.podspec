Pod::Spec.new do |s|
  ...
  s.summary            =  'SampleWidget'
  s.description        =  'SampleWidget'
  ...
  s.resources = ['sample-widget/source/**/*.{xib,storyboard,bundle,png,xcdatamodeld}']
  ...
  s.source_files = ['sample-widget/source/**/*.{h,m,swift}']
